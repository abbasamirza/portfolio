...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "bg-card text-card-foreground group/card flex flex-col gap-4 overflow-hidden rounded-md text-xs/relaxed has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:gap-2 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none",
        "border",
        className,
      )}
      {...props}
